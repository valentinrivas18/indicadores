...
query2 = "SELECT COUNT(*) from VinculoSolicitud WHERE id_carrera = 102"
...
query3 = "SELECT carrera from subprograma WHERE id_carrera = 102"
...
f1 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 1;"
cursor.execute(f1)
ff1 = cursor.fetchall()
fs1 = list(ff1[0])


f2 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 2;"
cursor.execute(f2)
ff2 = cursor.fetchall()
fs2 = list(ff2[0])


f3 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 3;"
cursor.execute(f3)
ff3 = cursor.fetchall()
fs3 = list(ff3[0])


f4 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 4;"
cursor.execute(f4)
ff4 = cursor.fetchall()
fs4 = list(ff4[0])


f5 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 5;"
cursor.execute(f5)
ff5 = cursor.fetchall()
fs5 = list(ff5[0])


f6 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 6;"
cursor.execute(f6)
ff6 = cursor.fetchall()
fs6 = list(ff6[0])


f7 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 7;"
cursor.execute(f7)
ff7 = cursor.fetchall()
fs7 = list(ff7[0])

f8 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 8;"
cursor.execute(f8)
ff8 = cursor.fetchall()
fs8 = list(ff8[0])

f9 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 9;"
cursor.execute(f9)
ff9 = cursor.fetchall()
fs9 = list(ff9[0])

f10 = "Select COUNT(*) from VinculoSolicitud WHERE id_carrera = 102 and id_solicitud = 10;"
cursor.execute(f10)
...
c = canvas.Canvas("102.pdf", pagesize=letter)
